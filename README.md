...
- <b>Infrastructure as Code / Compliance Automation</b>
  ...
  - [OSCAL Component Definition & Profile (compliance-trestle, NIST 800-53) — machine-readable control catalog-to-evidence traversal: a validated OSCAL component definition linking sc-28/ac-3/au-3/cm-6 to a live signed evidence bundle, verified end-to-end via CHAIN INTACT](https://github.com/Larry-Wilkes-CyberCloud/cge-p-capstone/tree/master/oscal)
---
